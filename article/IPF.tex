...
\begin{table}[h!]
\caption{
Comparison of mean errors $\error = \norme{\hat{\point}_0-\point_0}/\norme{\point_0}$ on the identification of the initial conditions $\point_0$, when $\hat{\point}_0$ is identified with 4D-Var and IPF.
}
\begin{centering}
...
$ g=      1.0\times 10^{-2}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ \\ 
\end{tabular}
