...
$ g=      1.0\times 10^{-2}$ & $ 5.0\times 10^{-2}$ & $9.4\times 10^{-5}$ & $4.0\times 10^{-2}$ & $1.2\times 10^{-3}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ \\ 
\end{tabular}
...
$ g=      1.0\times 10^{-2}$ & $1.0\times 10^{-1}$ & $1.5\times 10^{-5}$ & $7.5\times 10^{-2}$ & $2.0\times 10^{-4}$ & $?\times 10^{-?}$ & $?\times 10^{-?}$ \\ 
\end{tabular}
